...
Release archives and `checksums.txt` carry [SLSA build provenance](https://slsa.dev)
attested by GitHub (keyless Sigstore). To verify a downloaded artifact really was
